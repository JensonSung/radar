...
public class SQLite3ColumnBuilder {
    ...
    private boolean allowDefaultValue = false; // Radar does not support default
    ...
    public String createColumn(String columnName, SQLite3GlobalState globalState, List<SQLite3Column> columns) {
        ...
        if (Randomly.getBooleanWithSmallProbability() && globalState.getDbmsSpecificOptions().oracles != SQLite3OracleFactory.EDC) {
