...
public class MySQLTableGenerator {
    ...
    private void appendColumnDefinition() {
        ...
        columnOptions.remove(ColumnOptions.COMMENT); // do not generate comment
    ...
    private void appendTypeString(MySQLDataType randomType) {
        ...
        if (randomType.isNumeric()) {
            ...
            // zerofill is deprecated, since MySQL 8.0.17, anything on it should not be trusted. see https://bugs.mysql.com/bug.php?id=110170
