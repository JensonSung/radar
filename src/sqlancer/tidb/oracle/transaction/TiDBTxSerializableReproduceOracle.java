...
public class TiDBTxSerializableReproduceOracle extends TiDBTxWriteSerializableOracle {

    public TiDBTxSerializableReproduceOracle(TiDBProvider.TiDBGlobalState state) {
        super(state);
    }
